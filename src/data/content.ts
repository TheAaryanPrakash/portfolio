...
export const about = {
  paragraphs: [
    ...
    "Outside of this, I enjoy writing optimistic science and tech stories, along with technical articles. And when I want to step away from the screens, I love exploring and experiencing the world and capturing it through my lens.",
  ],
};
